...
> [原文链接](https://github.com/VSCodeVim/Vim/blob/master/ROADMAP.md)
...
## [](#marks-and-motions)Marks and motions
...
## [](#insert-mode-keys)Insert mode keys
...
## [](#special-keys-in-insert-mode)Special keys in Insert mode
...
## [](#text-objects-only-in-visual-mode-or-after-an-operator)Text objects (only in Visual mode or after an operator)
...
## [](#undoredo-commands)Undo/Redo commands
...
## [](#multi-window-commands)Multi-window commands
